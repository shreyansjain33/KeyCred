...
// hmac-secret structures - may not be defined in older SDKs (requires WEBAUTHN_API_VERSION >= 3)
#ifndef WEBAUTHN_HMAC_SECRET_SALT_DEFINED
#define WEBAUTHN_HMAC_SECRET_SALT_DEFINED

// Check if these structures are already defined by the SDK
#ifndef _WEBAUTHN_HMAC_SECRET_SALT_
#define _WEBAUTHN_HMAC_SECRET_SALT_
...
#ifndef _WEBAUTHN_CRED_WITH_HMAC_SECRET_SALT_
#define _WEBAUTHN_CRED_WITH_HMAC_SECRET_SALT_
...
#ifndef _WEBAUTHN_HMAC_SECRET_SALT_VALUES_
#define _WEBAUTHN_HMAC_SECRET_SALT_VALUES_
...
#endif // WEBAUTHN_HMAC_SECRET_SALT_DEFINED
